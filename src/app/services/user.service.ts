...
export class UserService {
  ...
  getRequestDetails(id)
  {
    ...
    return this.http.post('http://localhost:8098/ngorequestdetails',{params:params2} ).toPromise();
  }
  ...
  childShow(user)
  {
    return this.http.post('http://localhost:8098/reqchildonCondition',user).toPromise();
  }
